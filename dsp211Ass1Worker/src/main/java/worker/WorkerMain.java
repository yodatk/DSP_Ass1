...
//        if(args.length < 1){
//            System.out.println("image link was not given");
//            return;
//        }
        String url = "http://www.columbiamt.com/CMT-Marking-Stamps/images/OCR-A-Font.gif"; //args[0];
        Worker w = new Worker();
        System.out.println(w.newImageTaskWithTessaract(url));
